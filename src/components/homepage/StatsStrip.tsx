...
const stats = [
  { icon: BookOpen, value: 500, suffix: "+", label: "Stories Published" },
  { icon: Persons, value: 10, suffix: "K+", label: "Monthly Readers" },
  { icon: PencilToLine, value: 50, suffix: "+", label: "Active Writers" },
  { icon: Layers, value: 8, suffix: "+", label: "Categories Covered" },
];
